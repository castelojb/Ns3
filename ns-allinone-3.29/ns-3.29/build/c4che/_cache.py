...
CFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-fdebug-prefix-map==/usr/local/src/conda/-', '-fdebug-prefix-map==/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-g', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-fdebug-prefix-map==/usr/local/src/conda/-', '-fdebug-prefix-map==/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-g', '-fwrapv', '-O3']
...
EXAMPLE_DIRECTORIES = ['wireless', 'socket', 'matrix-topology', 'routing', 'naming', 'traffic-control', 'tcp', 'error-model', 'energy', 'realtime', 'ipv6', 'udp', 'tutorial', 'stats', 'udp-client-server']
...
INCLUDES_PYEMBED = ['/home/joao/anaconda3/include/python3.7m']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_PYEMBED = ['/home/joao/anaconda3/lib/python3.7/config-3.7m-x86_64-linux-gnu', '/home/joao/anaconda3/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
...
NS3_EXECUTABLE_PATH = ['/home/joao/NS3/ns-allinone-3.29/ns-3.29/build/src/fd-net-device', '/home/joao/NS3/ns-allinone-3.29/ns-3.29/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/8', '/home/joao/NS3/ns-allinone-3.29/ns-3.29/build/lib']
...
cfg_files = ['/home/joao/NS3/ns-allinone-3.29/ns-3.29/build/ns3/config-store-config.h', '/home/joao/NS3/ns-allinone-3.29/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
